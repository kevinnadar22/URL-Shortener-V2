...
SOURCE_CODE = os.environ.get("SOURCE_CODE", "https://github.com/Alpha1186/URL-Shortener-V2") # for upstream repo
WELCOME_IMAGE = os.environ.get("WELCOME_IMAGE", 'True') # image when someone hit /start
LINK_BYPASS = is_enabled((os.environ.get('LINK_BYPASS', "False")), False) # if true, droplink urls will be bypassed 
BASE_SITE = os.environ.get("BASE_SITE", "linksearn.site") # your shortener site domain
